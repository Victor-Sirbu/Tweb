...
type Notification = {
    id: number;
    type: "programare" | "rezultat" | "reminder" | "sistem";
    title: string;
    message: string;
    time: string;
    read: boolean;
...
const initialNotifications: Notification[] = [
    ...
    { id: 3, type: "reminder", title: "Reminder consultație mâine", message: "Mâine la ora 14:00 aveți consultație cu Ana Vasilescu la Dr. Ana Vasilescu (Pediatrie).", time: "1 oră în urmă", read: false },
    ...
    { id: 7, type: "reminder", title: "3 programări mâine", message: "Mâine aveți 3 programări: 09:00 Ion Ionescu, 11:00 Maria Popescu, 15:30 George Mihai.", time: "Ieri, 08:00", read: true },
...
const typeConfig = {
    ...
    reminder:   { label: "Reminder",   color: "#d97706", bg: "#fef3c7" },
